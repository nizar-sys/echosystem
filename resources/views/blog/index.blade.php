            ...
            <div class="card">
                <div class="row">
                    <div class="col-md-5 wrapthumbnail">
                        <a href="post.html">
                            <div class="thumbnail"
                                style="background-image:url({{ asset('/') }}assets/img/demopic/2.jpg);">
                            </div>
                        </a>
                    </div>
                    <div class="col-md-7">
            ...
            <div class="card">
                <div class="row">
                    <div class="col-md-5 wrapthumbnail">
                        <a href="post.html">
                            <div class="thumbnail"
                                style="background-image:url({{ asset('/') }}assets/img/demopic/3.jpg);">
                            </div>
                        </a>
                    </div>
                    <div class="col-md-7">
            ...
            <div class="card">
                <div class="row">
                    <div class="col-md-5 wrapthumbnail">
                        <a href="post.html">
                            <div class="thumbnail"
                                style="background-image:url({{ asset('/') }}assets/img/demopic/4.jpg);">
                            </div>
                        </a>
                    </div>
                    <div class="col-md-7">
